import { state, selectedSource, isDirty, isReplaceableEl, stateBadge } from "./state.js";
...
function renderRow(e) {
  ...
  return `
    <div class="list-row${sel}${dirty ? ' dirty' : ''}${!isReplaceableEl(e) ? ' readonly' : ''}" data-id="${escape(e.id)}">
